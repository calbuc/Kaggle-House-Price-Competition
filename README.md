...
## Usage
As per Kaggle's terms the dataset required is not included in the repository. To run the notebook locally you can download the data set from the [competition page](https://www.kaggle.com/competitions/house-prices-advanced-regression-techniques) and place the files in the working directory.
